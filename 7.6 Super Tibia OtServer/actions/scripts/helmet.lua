...
piece1pos = {x=1688, y=889, z=7, stackpos=1}
piece2pos = {x=1687, y=890, z=7, stackpos=1}
piece3pos = {x=1688, y=891, z=7, stackpos=1}
piece4pos = {x=1687, y=892, z=7, stackpos=1}
piece5pos = {x=1688, y=893, z=7, stackpos=1}
piece6pos = {x=1687, y=894, z=7, stackpos=1}
piece7pos = {x=1688, y=895, z=7, stackpos=1}
helmetpos = {x=1683, y=888, z=7, stackpos=1}
