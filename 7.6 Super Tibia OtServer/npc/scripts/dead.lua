...
function onCreatureSay(cid, type, msg)
  	...
  	if (msgcontains(msg, 'hi') and (focus == 0)) and getDistanceToCreature(cid) < 4 then
		if isPremium(cid) then
			selfSay('Hello ' .. creatureGetName(cid) .. '!  Hello!!! Estou aki para lhe da uma passage para um inferno... Mais quem é o chefe dos Demons aki no serv ? Me responda e posso te da uma passage.')
			focus = cid
			talk_start = os.clock()
