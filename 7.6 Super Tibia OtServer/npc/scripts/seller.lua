...
function onCreatureSay(cid, type, msg)
  	...
  	if (msgcontains(msg, 'hi') and (focus == 0)) and getDistanceToCreature(cid) < 4 then
  		selfSay('Hello, ' .. creatureGetName(cid) .. '! I sell Ropes (50gp), Shovels (20gp), Backpacks (50gp), Scythes (50gp), Picks (50gp), Life Fluids (60gp), Fishing Rods (100gp) and Torches (2gp). I buy Vials (10gp).')
  		focus = cid
  		talk_start = os.clock()
