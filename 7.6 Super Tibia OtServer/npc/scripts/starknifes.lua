...
function onCreatureSay(cid, type, msg)
  	...
  	if (msgcontains(msg, 'hi') and (focus == 0)) and getDistanceToCreature(cid) < 4 then
  		selfSay('Hello ' .. creatureGetName(cid) .. '! I sell Throwing Stars (400gps), Throwing Knifes (400gps), Poison Arrows (300gps), Burst Arrows (600gps) and Power Bolts (1K), each have 100x')
  		focus = cid
  		talk_start = os.clock()
